...
For anyone in STM who wants to change the constitution. It assumes you have never
written YAML and are not sure what a terminal is. It does not assume you are slow —
read it once, straight through, and you will be able to draft a bill.

Governance — who votes, when, and what happens after you hand it in — is in
